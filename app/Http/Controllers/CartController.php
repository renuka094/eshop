...
class CartController extends Controller {
    public function index(Request $request) {
        ...
        return view('front.carts.cart', ['cartItems' => $cartData, 'subtotal' => $total]);
    }
    public function checkout(Request $request) {
        ...
        return view('front.carts.checkout', ['cartItems' => $cartData, 'subtotal' => $total]);
    }
    public function doCheckout(Request $request) {
        ...
        if (Auth::user()) {
            $insertData = array('email' => Auth::user()->email, 'customer_name' => Auth::user()->name, 'customer_id' => Auth::user()->id, 'customer_type' => 'customer');
        } else {
            $insertData = array('email' => $data['email'], 'customer_name' => $data['name'], 'customer_type' => 'guest');
        }
        ...
        $insertPData = array('order_id' => $lastInsertedID);
        foreach ($cartData as $key => $value) {
            if ($key != '') {
                $product = Products::find($key);
